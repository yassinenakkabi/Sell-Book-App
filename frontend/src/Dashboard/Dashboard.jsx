        ...
        <div className="bg-[#5956e9] rounded-3xl p-8 mb-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-x-2">
              <button type="button" className="inline-flex items-center justify-center h-9 px-3 rounded-xl border hover:border-[#ffffff] text-gray-800 hover:text-gray-900 transition">
