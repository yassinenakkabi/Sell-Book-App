...
export const Banner = () => {
    return (
        <div className=' bg-[#5956e9]  px-4 lg:px-24 flex items-center'>
            <div className='flex flex-col md:flex-row-reverse justify-between items-center gap-12 py-40'>
                ...
                {/* left side */}
                <div className='md:w-1/2 space-y-8 bg-[#5956e9]'>
                    ...
                    <div>
                        ...
                        <button className='bg-[#5956a0] px-6 py-2 text-white font-medium hover:bg-black transition-all ease-in duration-200'>Recherche</button>
                    </div>
                </div>
            </div>
        </div>
