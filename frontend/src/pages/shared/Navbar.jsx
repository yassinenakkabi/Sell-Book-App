            ...
            <nav className={`py-4 lg:px-24 px-4 ${isSticky ? "sticky top-0 left-0 right-0 bg-[#ffffff]" : ""
                ...
                <div className="flex justify-between items-center text-base gap-8">
                    ...
                    <div className="space-x-12 hidden lg:flex items-center">
                       <button> <FaBarsStaggered className="w-5 hover:text-[#5956e9]" /></button>
                    </div>
                ...
                <div
                    className={`space-y-4 px-4 mt-16 py-7 bg-[#5956e9] ${isMenuOpen ? "block fixed top-0 right-0 left-0" : "hidden"}`}
                >
                    {
